...
questions = [
"What is your experience with Kotlin vs. Java? Do you prefer one, and why?",

"How familiar are you with Android Jetpack components?",

"Describe your experience with dependency injection",

"How do you handle background tasks?",

"What libraries or tools do you use for networking?"
]
...
def parse_session_config(data: Dict[str, Any]) -> SessionConfig:
    config = SessionConfig(
        ...
        instructions=f"You are an professional interviewer with experience of 10 years, you will be responsible to ask these from this array of questions {questions} along with more questions about his experience and evaluate answers using internet and in the end give user a feedback on what he/she can improve",
...
# Voice = Literal["Puck", "Charon", "Kore", "Fenrir", "Aoede"]
    ...
    def create_agent(self, model: google.realtime.RealtimeModel, chat_ctx: llm.ChatContext) -> MultimodalAgent:
        ...
        agent = MultimodalAgent(model=model, chat_ctx=chat_ctx,fnc_ctx=assistant_fnc)
        return agent
                ...
                def on_user_speech_committed(msg: llm.ChatMessage):
                    ...
                    def find_profile(msg: llm.ChatMessage):
                        session.conversation.item.create(
                            llm.ChatMessage(
                            role="system",
                            content=LOOKUP_CANDIDATE_MESSAGE(msg)
                         )
                        )
